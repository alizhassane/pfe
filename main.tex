...
\addbibresource{webography.bib} %Import the bibliography file
...
\begin{table}[H]
    \centering
    \begin{tabular}{ | m{2,5cm} | m{3,2cm}| m{3cm} |m{0,9cm}|m{0,9cm}|l|}
    \hline
...
Nous présentons dans la suite les approches basées sur le contenu et le filtrage collaboratif, puis les approches hybrides (figure \Ref{class}).
\begin{figure}[H]
    \centering
...
\begin{figure} [H]
    \centering
    \includegraphics[width=1\textwidth]{images/Chargement des données.png}
